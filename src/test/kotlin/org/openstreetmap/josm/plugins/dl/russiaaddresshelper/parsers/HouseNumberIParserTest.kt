...
internal class HouseNumberIParserTest {
    ...
    companion object {
        ...
        fun addresses() = listOf(
            Arguments.of("Российская Федерация, Санкт-Петербург, внутригородское муниципальное образование Санкт-Петербурга поселок Шушары, Пулковское шоссе, дом 60, корпус 1, строение 4", "60 к1 с4", ""),
