...
internal class AddressParserTest {
    ...
    fun parseTest() {
        ...
        val parsedAddress2 = addressParser.parse(
        ...
        assertTrue(
            parsedAddress.flags.containsAll(
                listOf(
                    ParsingFlags.PLACE_HAS_NUMBERED_NAME,
                    ParsingFlags.HOUSENUMBER_CANNOT_BE_PARSED
                )
            )
        )
        ...
        egrnAddress =
            "Российская Федерация, Московская область, городской округ Дмитровский, поселок Некрасовский, пер. 5-ый"
        ...
        egrnAddress =
            "Калужская область, р-н. Мосальский, г. Мосальск, в направлении 100 метров на северо запад от ориентира ул. Ломоносова, д. 65, кв. квартира 2"
        val parsedAddress5 = addressParser.parse(egrnAddress, EastNorth.ZERO, ds1)
        assertTrue(parsedAddress5.flags.contains(ParsingFlags.STOP_LIST_WORDS))
    ...
    fun parseAllTest(
        ...
        flags: List<ParsingFlags>?
    ) {

        val addressParser = AddressParser()
        val parsedAddress = addressParser.parse(address, EastNorth.ZERO, ds!!)

        if (expectedPlaceName != null) {
            assertEquals(expectedPlaceName, parsedAddress.parsedPlace.name)
        }
    ...
    private fun getDataset(): DataSet {
        ...
        ds.addPrimitive(getPlace("Голубино", "town"))
        return ds;
    }
    ...
    companion object {
        ...
        fun addresses() = listOf(
            Arguments.of(
                "Российская Федерация, Архангельская область, м.р-н Пинежский, с.п. Пинежское, п. Голубино, д. 1Б",
                "Голубино",
                null,
                "1Б",
                "",
            ...
            Arguments.of("Красноярский край, г. Минусинск, ул. Штабная, 13-1", null, null, "13", "1", null),
            Arguments.of(
                "Красноярский край, г. Минусинск, ул. Канская, 41- 1,2,3,4",
                null,
                null,
                "41",
                "1,2,3,4",
            ...
            Arguments.of(
                "обл. Калужская, р-н Жуковский, г. Жуков, ул. М.Горького, дом № 77, квартира № 2",
                null,
                null,
                "77",
                "2",
            ...
            Arguments.of(
                "Калужская обл, р-н Спас-Деменский, г Спас-Деменск, ул Советская, д 3, корп 1",
                null,
                null,
                "3 к1",
                "",
            ...
            Arguments.of(
                "Калужская обл., р-н Мосальский, г. Мосальск, ул. Кирова, д. 34, помещение № 2",
                null,
                null,
                "34",
                "",
            ...
            Arguments.of(
                "Калужская обл., р-н Мосальский, г. Мосальск, ул. Гагарина, дом 10 \"Г\", кв. 1",
                null,
                null,
                "10Г",
                "1",
            ...
            Arguments.of(
                "Красноярский край, Ачинский район, п. Малиновка, квартал 1, строение 3",
                null,
                null,
                "",
                "",
            ...
            Arguments.of(
                "Российская Федерация, Красноярский край, Городской округ город Ачинск, г. Ачинск, мкр. 1-й",
                null,
                null,
                "",
                "",
                listOf(ParsingFlags.PLACE_HAS_NUMBERED_NAME, ParsingFlags.HOUSENUMBER_CANNOT_BE_PARSED)
            ),
            //  Arguments.of("Красноярский край, Ачинский район, п. Малиновка, квартал 1, строение 3", null,null, "", "", null),
            //   Arguments.of("Красноярский край, Ачинский район, п. Малиновка, квартал 1, строение 3", null,null, "", "", null),

            Arguments.of(
                "Самарская область, г. Самара, р-н. Красноглинский, п. Мехзавод, кв-л. 8-й, д. 8",
                "8-й квартал",
                null,
                "8",
                "",
