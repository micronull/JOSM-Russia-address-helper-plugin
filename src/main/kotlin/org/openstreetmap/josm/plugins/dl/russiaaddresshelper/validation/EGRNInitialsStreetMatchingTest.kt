...
class EGRNInitialsStreetMatchingTest : Test(
    I18n.tr("EGRN initials match"),
    I18n.tr("EGRN test for parsed street name match with OSM without initials/or first name")
) {
    ...
    override fun fixError(testError: TestError): Command? {
        ...
        p.add(JLabel(I18n.tr("Присвоить улице имя:")), GBC.std())
        ...
        val dialog = ExtendedDialog(
            ...
            I18n.tr("Исправление ошибки сопоставления без инициалов"),
            *buttonTexts
        )
    ...
    override fun isFixable(testError: TestError): Boolean {
        return testError.tester is EGRNInitialsStreetMatchingTest
    }
